  ...
  <body>
    ...
    <section id="home" class="hero-section text-center">
      <div class="container">
        ...
        <h2 class="mb-4">Lembaga</h2>
        <a href="#lembaga" class="btn btn-masuk btn-lg">Learn More</a>
      </div>
    </section>

    <!-- Lembaga Section -->
    <section id="lembaga" class="section-padding bg-light">
      <div class="container mt-2">
        <div class="row">
          <!-- Header Row -->
          <div class="col-md-8">
            <h4 class="fw-bold section-title">Lembaga Desa</h4>
          </div>
          <div class="col-md-4">
            <h4 class="fw-bold section-title">Lainnya</h4>
          </div>
        </div>
          ...
          <div class="col-md-8">
            <table class="table">
              ...
              <tbody>
                <tr class="highlight">
                  <td>1</td>
                  <td>BUMDES MAJAU JAYA ABADI (BUMDES)</td>
                  <td>Jalan Baning Hulu Gang Utama</td>
                  <td><a href="#" class="link">Lihat</a></td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>BADAN PERMUSYAWARATAN DESA (BPD)</td>
                  <td>Jalan Baning Hulu</td>
                  <td><a href="lembaga_detail" class="link">Lihat</a></td>
                </tr>
                <tr>
                  <td>3</td>
                  <td>LEMBAGA PEMBERDAYAAN MASYARAKAT (LPM)</td>
                  <td>Jalan Baning Hulu</td>
                  <td><a href="#" class="link">Lihat</a></td>
                </tr>
                <tr>
